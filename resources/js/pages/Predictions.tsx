        ...
        post(
            '/predict',
            {
                ...
                onSuccess: () => {
                    ...
                    /*
                     * Inertia will redirect back to
                     * the predictions page after the
                     * Laravel controller finishes.
                     */
                },
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/60 backdrop-blur-sm">
                    ...
                    <div className="flex flex-col items-center gap-3 rounded-2xl bg-white p-8 shadow-2xl">
                        ...
                        <p className="text-sm text-slate-500">
                            Calculating enrollment forecast.
                        ...
                        <div className="mt-6 flex flex-col gap-6">
                            ...
                            <div className="grid grid-cols-1 gap-6 xl:grid-cols-4">
                                ...
                                <form
                                    ...
                                    className="flex flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm xl:col-span-1"
                                >
                                    ...
                                    <p className="mb-6 text-sm text-slate-500">
                                        Select the forecast parameters.
                                    </p>
                                    ...
                                    <div className="flex flex-col gap-5">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    className="w-full rounded-xl border border-slate-300 bg-slate-50 px-3 py-2.5 text-sm text-slate-700 outline-none focus:border-emerald-500 focus:bg-white disabled:cursor-not-allowed disabled:opacity-50"
                                                >
                                        ...
                                        <button
                                            ...
                                            className="mt-4 flex w-full items-center justify-center rounded-xl bg-emerald-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
                                        >
